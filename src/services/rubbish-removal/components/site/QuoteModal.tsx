...
import { PRICING, SITE, modalBenefits } from "@/services/rubbish-removal/lib/site-data";
          ...
          <div className="grid min-h-full place-items-center p-3 sm:p-6">
            ...
            >
              ...
              {/* ---------------- Left: the pitch ----------------
                  ...
                  headline, four benefits, a rating badge and a phone number
                  underneath the form — and every one of those arguments is one
                  the visitor has already read and accepted, or they would not
                  have tapped the button. That matters more now the hero card is
                  desktop-only: on a phone this modal IS the form, so anything
                  above the first field is something between the visitor and the
                  thing they asked for. Side by side on desktop it costs nothing,
                  so it stays there. */}
              <div className="relative hidden overflow-hidden bg-light p-5 sm:p-9 lg:order-1 lg:block">
                ...
                <div className="relative">
                  ...
                  <h2 className="font-heading mt-3 text-xl text-light-foreground sm:text-2xl">
                    Melbourne rubbish removal from <Highlight tone="green">{PRICING.min}</Highlight>
                    . We do the lifting.
                  </h2>
              ...
              {/* p-5 not p-7 below sm: the overlay already spends 24px on its
                  ...
                  fields. */}
              <div className="order-1 bg-primary p-5 sm:p-9 lg:order-2 lg:pt-9">
                ...
                {/* No comments field here: the modal is the quick-capture
