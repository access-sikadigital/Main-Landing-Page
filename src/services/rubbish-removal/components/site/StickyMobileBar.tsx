...
import { CTA_LABEL } from "@/services/rubbish-removal/lib/site-data";
 ...
 *
 * One button, not two. The call number used to sit beside it, which cost the
 * quote button a third of the bar and asked for a decision — ring now, or fill
 * in a form — at the exact moment the page wants a single obvious next step.
 * Calling has not gone anywhere: the floating contact button above this one
 * carries both the phone number and WhatsApp.
 *
 * See `usePastHero` for why it observes the hero rather than watching a scroll
 * offset.
 */
