...
import { SITE, CTA_LABEL, quoteForm, quoteServiceOptions } from "@/services/strip-out/lib/site-data";
import { quoteSchema, type QuoteValues } from "@/services/strip-out/lib/quote-schema";
import { submitLead } from "@/services/strip-out/lib/lead.functions";
import { captureTracking, getTracking } from "@/services/strip-out/lib/tracking";
...
export function QuoteForm({
  ...
  const onSubmit = async (values: QuoteValues) => {
    ...
    try {
      ...
      navigate({ to: "/thank-you-strip-out" });
    } catch {
      setErrorMsg(
