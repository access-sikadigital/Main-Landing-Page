...
import { PRICING, SITE, modalBenefits } from "@/services/strip-out/lib/site-data";
          ...
          <div className="grid min-h-full place-items-center p-3 sm:p-6">
            ...
            >
              ...
              {/* ---------------- Left: the pitch ----------------
                  ...
                  have tapped the button. Re-selling someone who has agreed just
                  gives them more to scroll past on the way to submitting. Side
                  by side on desktop it costs nothing, so it stays there. */}
